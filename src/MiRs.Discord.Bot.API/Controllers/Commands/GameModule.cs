...
{
    public class GameModule(ISender sender, IOptions<AppSettings> appSettings) : BaseModule(sender, appSettings)
    {
        /// <summary>
        ...
        /// </summary>
        [SlashCommand("teamloot", "Return the latest team drops")]
